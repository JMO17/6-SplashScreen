...
//	}
	...
	public void showHome() {
		try {
			...
			loader.setLocation(Main.class.getResource("vistaPrincipal.fxml"));
	...
	public void initialize() {
		...
		TranslateTransition translateTransition = new TranslateTransition(Duration.seconds(0.1), botella);
		...
		translateTransition.setOnFinished(event -> {
			...
			TranslateTransition translateTransition1 = new TranslateTransition(Duration.seconds(1), botella);
			...
			translateTransition1.setOnFinished(event1 -> {
				...
				TranslateTransition translateTransition11 = new TranslateTransition(Duration.seconds(2), nameLabel);
				...
				translateTransition11.setOnFinished(event2 -> {
					...
					translateTransition111.setOnFinished(event3 -> {
						...
						FadeTransition fadeTransition = new FadeTransition(Duration.seconds(4), spinnerPane);
